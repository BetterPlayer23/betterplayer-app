...
import { loadAntiCheat, promotionTime } from './antiCheat';
import { removeCrowns, removeFromBoards } from './boardEngine';
...
async function removeFromRankings(db: Firestore, uid: string, now: Date) {
  ...
  // Live boards: take the player out; players below move up (no notification).
